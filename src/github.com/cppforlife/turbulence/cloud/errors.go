...
func (e cpiError) Type() string { return e.cmdError.Type }

func (e cpiError) Message() string { return e.cmdError.Message }

func (e cpiError) OkToRetry() bool { return e.cmdError.OkToRetry }
